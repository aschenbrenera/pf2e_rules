...
- Attempt a skill check for the skill corresponding to your tradition (DC determined by the GM using [[Identifying and Learning|Learn DC]]) or shown below (Uncommon +2, Rare +5, Unique +10). Attempt a check with the relevant skill.
